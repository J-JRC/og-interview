...
public class ReporterLog4J implements IReporter{
	private static final Logger LOG = Logger.getLogger(ReporterLog4J.class);
	...
	public ReporterLog4J (Map<String,String> params, String path) throws IOException{
		...
		Logger.getRootLogger().addAppender(new RollingFileAppender(new PatternLayout("%d{yyyy-MM-dd HH:mm:ss} %-5p %c{1}:%L - %m%n"),  path));
	}
