...
public interface IBaseElement {
	 ...
	 */
	public List<IBaseElement> findElements(By by) throws UIException;
	 ...
	 * @see org.openqa.selenium.WebDriver.Timeouts
	 */
	public List<IBaseElement> findElements(String locator, LocatorType type) throws UIException;
	 ...
	 * @see org.openqa.selenium.WebDriver.Timeouts
	 */
	public IBaseElement findElement(By by) throws UIException;
	 ...
	 * @return boolean
	 */
	public boolean isDisplayed() throws UIException;
	 ...
	 * @return boolean
	 */
	public boolean isEnable() throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void setCheck(boolean check) throws UIException;
	 ...
	 */
	public void waitForEnable() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void waitForClickable() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void waitForDisable() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void waitForVisible() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void waitForInvisible() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void waitForNotPresent() throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void click() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void clickAsJScript() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void doubleClick() throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void rightClick() throws UIException;
	 ...
	 */
	public String getText() throws UIException;
	 ...
	 *             Any exception will be wrapped in UIExcepton
	 */
	public void setText(CharSequence... text) throws UIException;
	 ...
	 * 
	 */
	public void appendText(CharSequence... text) throws UIException;
	 ...
	 *         element
	 */
	public Point getLocation() throws UIException;
	 ...
	 */
	public Dimension getSize() throws UIException;

	/**
	 * @return The location and size of the rendered element
	 */
	public Rectangle getRect() throws UIException;
	 ...
	 */
	public String getCssValue(String propertyName) throws UIException;
	 ...
	 *         set.
	 */
	public String getAttribute(String name) throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void scrollIntoView(boolean isAlignTop) throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void scrollIntoView() throws UIException;
	 ...
	 *             throw a UIException
	 */
	public Object executeScript(String javascriptToExecute, Object... parameters) throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void hover() throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void hover(int xOffset, int yOffset) throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void dragTo(IBaseElement target) throws UIException;
	 ...
	 *             throw a UIException
	 */
	public void dragTo(Point target) throws UIException;
	/**
	 * 
	 * 
	 * @throws UIException
	 *             throw a UIException
	 */
	public void highlight() throws UIException;
	 ...
	 */
	public void selectByValue(String value) throws UIException;
	 ...
	 *             If no matching option elements are found
	 */
	public void selectByIndex(int index) throws UIException;
	 ...
	 *             If no matching option elements are found
	 */
	public void selectByText(String text) throws UIException;
	 ...
	 *             If no matching option elements are found
	 */
	public void deselectByValue(String value) throws UIException;
	 ...
	 *             If no matching option elements are found
	 */
	public void deselectByIndex(int index) throws UIException;
	 ...
	 *             If no matching option elements are found
	 */
	public void deselectByText(String text) throws UIException;
	 ...
	 */
	public String getSelectedItemValue() throws UIException;
	 ...
	 *             If no option is selected
	 */
	public IBaseElement getSelectedItem() throws UIException;
	 ...
	 *             If no option is selected
	 */
	public List<IBaseElement> getSelectedItems() throws UIException;
