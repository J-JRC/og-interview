...
public class BaseElement implements IBaseElement {
	...
	public List<IBaseElement> findElements(By by) throws UIException{
		...
		try {
			...
			throw new UIException(infoMsg, e);
		}
		return webElements;
	 ...
	 */
	@Override
	public void appendText(CharSequence... keysToSend) throws UIException {
	...
	public String getText() throws UIException {
		...
		if (element.getTagName().equalsIgnoreCase("input") || element.getTagName().equalsIgnoreCase("textarea")) {
			...
			try {
				...
				throw new UIException(String.format(infoMsg, text), e);
			}
		}
	...
	public void hover() throws UIException {
		...
		try {
			...
			try {
				...
				reporter.fail(infoMsg, e, BasicPageGateway.saveAsScreenShot(driver));
				throw new UIException(infoMsg, e1);
			}
		}
	...
	public void highlight() throws UIException {
		try {
			...
			throw new UIException("Highlight fail", e);
		}
	}
	 ...
	 */
	@Override
	public void dragTo(Point point) throws UIException   {
		String infoMsg = "Drag and drop: Drag element with locator [" + locatorString + "] to element";
		try {
	...
	private void dragAndDrop(WebDriver driver, WebElement source, WebElement target) throws UIException{
