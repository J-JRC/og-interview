...
public class BasicPageGateway {
	 ...
	 * @throws UIException 
	 */
	public static void waitForFrameToLoadAndSwitch(WebDriver driver, String locator, int timeout) throws UIException {
		try {
			...
			throw new UIException("waitForFrameToLoadAndSwitch: " + "[ " + locator + " ]", e);
		}
	}
	 ...
	 * @throws UIException 
	 */
	public static void waitForPageToLoad(WebDriver driver,int timeout) throws UIException {
	 ...
	 * 
	 */
	public static void waitForContentToLoad(WebDriver driver, String locator, int timeout) throws UIException {
		...
		try {
			...
			throw new UIException("waitForContentToLoad: " + "[ " + locator + " ]", e);
		}
	}
}