...
public class CustomSeleniumGateway {
	private static final Logger LOGGER = Logger.getLogger(CustomSeleniumGateway.class);
	...
	public static void waitUntilElementIsStale(WebDriver driver, WebElement elt, int timeout)
		...
		new WebDriverWait(driver, timeout).until(ExpectedConditions.stalenessOf(elt));
	}
	...
	public static void waitForElementToBeClickable(WebDriver driver, WebElement elt, int timeout) {
		new WebDriverWait(driver, timeout).until(ExpectedConditions.elementToBeClickable(elt));
	}
	...
	public static Boolean waitUntilElementIsInvisible(WebDriver driver, By locator, int timeout) {
		return (new WebDriverWait(driver, timeout)).until(invokeElementExpectedConditionByInvisiblility(locator));
	}
