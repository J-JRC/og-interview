...
public class BasicBrowserHelper {
	 ...
	 * @throws UIException
	 */
	public static String openWindow(WebDriver driver) throws UIException {
	 ...
	 * @throws UIException
	 */
	public static void closeWindow(WebDriver driver, String windowHandle) throws UIException {
	 ...
	 * @throws UIException
	 */
	public static void switchToWindow(WebDriver driver, String windowHandle) throws UIException {
	 ...
	 * @throws UIException
	 */
	public static Alert getAlert(WebDriver driver) throws UIException {
