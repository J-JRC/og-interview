...
public class BaseElementHandler implements InvocationHandler{
	...
	public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
	    ...
	    if (element == null && ( ((DefaultElementLocator) locator).getUntil() != Until.NotPresent 
				...
				throw new RuntimeException("Cannot find element :["+ locatorKey + "] locator:[" + locator.toString() + "]");
	    }
		
	    Constructor<?> cons = null;
	    cons = classType.getConstructor(WebDriver.class,WebElement.class, String.class, ElementLocator.class, String.class);
	    try {
	    	return method.invoke(cons.newInstance(page.getDriver(),element,locatorKey,locator,page.getFootPrint()), objects);
