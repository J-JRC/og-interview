...
public class BaseElementListHandler implements InvocationHandler{
	...
	public <T> BaseElementListHandler(Class<?> interfaceType, Class<?> classType, String locatorKey, ElementLocator locator, BasePage page) {
	...
	public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
	    ...
	    try {
	    	...
	    	for(WebElement e: elements){
	    		results.add((BaseElement) cons.newInstance(page.getDriver(),e,locatorKey,locator.toString(),page.getFootPrint()));
		    }
