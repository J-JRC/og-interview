...
public class ControlCenter {
	...
	public void initialize(Map<String, String> params) throws UIException {
		this.parameters = params;
		
		threadLocalComponents = new ThreadLocal<ComponentManager>();
		if (!params.containsKey(APPLICATION_SERVER)) {
			throw new UIException("Application url is mandatory. Please set this value and run again");
		}
