...
//				reporter.reportStep(StepStatus.SKIPPED, "Skipped test case [" + Thread.currentThread().getName()
//						+ "] : " + tr.getName() + "<BR>" + tr.getThrowable().getMessage());
//			} else {
//				reporter.reportStep(StepStatus.SKIPPED,
//						"Skipped test case [" + Thread.currentThread().getName() + "] : " + tr.getName());
//			}
//		}
